...
ui模块提供了编写用户界面的支持。
    ...
    给Android开发者或者高阶用户的提醒，AutoTools的UI系统来自于Android，所有属性和方法都能在Android源码中找到。如果某些代码或属性没有出现在AutoTools的文档中，可以参考Android的文档。
...
ui.post(() => {
    // 修改文本
    $ui.example.attr("text", "Hello, AutoTools UI");
    // 修改背景
